...
const mockArticles: Article[] = [
    {
        ...
        excerpt:
            "Retrouvez tous les créneaux par catégorie au gymnase Auguste Delaune dès la semaine prochaine. Pensez à finaliser vos dossiers d'inscription !",
    ...
    {
        id: "2",
        title: "Stage de perfectionnement Jeunes pendant les vacances de la Toussaint",
        slug: "stage-jeunes-toussaint-2026",
        excerpt:
            "Inscriptions ouvertes pour le stage U11-U15 organisé par nos entraîneurs diplômés du 19 au 23 octobre.",
    ...
    {
        id: "3",
        title: "Victoire encourageante des Seniors D3 en préparation",
        slug: "victoire-seniors-d3-preparation",
        excerpt:
            "Beau succès collectif pour notre équipe fanion lors du tournoi de pré-saison contre Hérouville (64-58).",
        date: "10 Septembre 2026",
        category: "Compétition",
        author: "Entraîneur Senior",
    },
    {
        id: "4",
...
const categories = ["Toutes", "Club", "Stage", "Compétition", "Événement"];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl mb-10">
                ...
                <p className="text-gray-600 text-sm sm:text-lg">
                    Résultats des matchs, événements à venir, stages et infos
                    officielles du Fleury Basket.
                </p>
            </div>
